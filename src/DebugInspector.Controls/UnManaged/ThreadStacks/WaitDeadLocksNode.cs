...
{
    internal class WaitDeadLocksNode
    {
        ...
        internal WaitDeadLocksNode(ThreadStackNodeManager manager, TreeNode rootNode)
        {
            if (rootNode == null)
            ...
            r_deadlocksNode = rootNode.Nodes.Add("WaitDeadLocks");
            ...
            Refresh(r_manager.ThreadStackManager.WaitDeadLocks);
        }
